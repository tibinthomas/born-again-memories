...
## Corpus Check
- 1291 files · ~746,770 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5622 nodes · 6222 edges · 214 communities detected
...
Cohesion: 0.01
Nodes (62): PodsDummy_AppAuth, PodsDummy_AppCheckCore, PodsDummy_audioplayers_darwin, AuthUIDelegate, DKImageBaseManager, DKImageBaseManagerObserver, PodsDummy_DKImagePickerController, PodsDummy_DKPhotoGallery (+54 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (165): attachment.dart, attachment_preview.dart, dart:async, dart:io, external_link.dart, firebase_options.dart, link_preview_card.dart, milestone.dart (+157 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (74): AuthProviderID, AuthSessionStore, Codable, CodingKey, CustomNSError, Equatable, Error, GTMSessionFetcherAuthorizer (+66 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (77): AuthOperationType, link, reauth, signUpOrSignIn, unspecified, update, AuthSettings, DKImageAssetDiskPurger (+69 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (44): OIDAuthorizationResponse, -copyWithZone, -description, -encodeWithCoder, -fieldMap, -initparameters, -initWithCoder, -supportsSecureCoding (+36 more)
...
Cohesion: 0.03
Nodes (54): AuthCredential, FacebookAuthCredential, FacebookAuthProvider, GameCenterAuthCredential, GameCenterAuthProvider, WarningWorkaround, GitHubAuthCredential, GitHubAuthProvider (+46 more)
...
Cohesion: 0.03
Nodes (19): DKAssetGroupDetailImageCell, DKImageCheckView, DKPhotoBasePreviewVC, DKPhotoIncrementalIndicator, DKPhotoIncrementalIndicatorDirection, left, right, DKPhotoIncrementalLeftIndicator (+11 more)
...
Cohesion: 0.04
Nodes (18): DKAssetGroupDetailBaseCell, DKImageDataManager, getImageDataManager(), DKImageGroupDataManagerObserver, DKImagePickerControllerAware, DKImagePickerControllerObserver, DKAsset, FetchKeys (+10 more)
...
Cohesion: 0.03
Nodes (26): ActionCodeInfo, ActionCodeOperation, emailLink, passwordReset, recoverEmail, revertSecondFactorAddition, unknown, verifyAndChangeEmail (+18 more)
...
Cohesion: 0.04
Nodes (13): AuthKeychainStorage, DKImageBaseManager, DKImageBaseManagerObserver, DKImageGroupDataManager, DKImageGroupDataManagerConfiguration, DKImageGroupDataManagerObserver, DKImagePickerController, DKAsset (+5 more)
...
Cohesion: 0.03
Nodes (25): AnyObject, AuthWebViewControllerDelegate, DKUINavigationController, DKPhotoBaseImagePreviewVC, DKPhotoImageView, OIDExternalUserAgentIOS, -cleanUp, -dismissExternalUserAgentAnimatedcompletion (+17 more)
...
Cohesion: 0.04
Nodes (20): FederatedAuthProvider, DKPhotoGallery, DKPhotoGalleryDelegate, DKPhotoGalleryIncrementalDataSource, DKPhotoGallerySingleTapMode, dismiss, toggleControlView, UIViewController (+12 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (13): class, DKPhotoGalleryContentDataSource, DKPhotoGalleryContentDelegate, DKPhotoGalleryContentFooterViewContainer, DKPhotoGalleryContentVC, DKPhotoBasePreviewDataSource, DKPhotoBasePreviewVC, DKPhotoPreviewType (+5 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (32): UIButton, -sd_backgroundImageOperationKeyForState, -sd_backgroundImageURLForState, -sd_cancelBackgroundImageLoadForState, -sd_cancelImageLoadForState, -sd_currentBackgroundImageURL, -sd_currentImageURL, -sd_imageOperationKeyForState (+24 more)
...
Cohesion: 0.05
Nodes (22): DKAssetGroupDetailCameraCell, UIImageView, -sd_cancelCurrentImageLoad, -sd_currentImageURL, -sd_setImageWithURL, -sd_setImageWithURLcompleted, -sd_setImageWithURLplaceholderImage, -sd_setImageWithURLplaceholderImagecompleted (+14 more)
...
Cohesion: 0.12
Nodes (4): AuthComponent, ComponentLifecycleMaintainer, Library, AuthKeychainServices
...
## Knowledge Gaps
- **2508 isolated node(s):** `-sharedInstance`, `-init`, `-setLoggerLevel`, `-loggerLevel`, `-ISO8601String` (+2503 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 109`** (9 nodes): `AuthLog.swift`, `AuthLog.swift`, `AuthLog`, `.log()`, `.logDebug()`, `.logError()`, `.logInfo()`, `.logNotice()`, `.logWarning()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (8 nodes): `IdentityToolkitRequest`, `.init()`, `.queryParams()`, `.requestConfiguration()`, `.requestURL()`, `.setHost()`, `IdentityToolkitRequest.swift`, `IdentityToolkitRequest.swift`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 158`** (6 nodes): `AtomicBox.swift`, `AtomicBox.swift`, `AtomicBox`, `.init()`, `.value()`, `.withLock()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 162`** (6 nodes): `DKAssetGroupDetailVideoCell`, `.cellReuseIdentifier()`, `.init()`, `.layoutSubviews()`, `DKAssetGroupDetailImageCell`, `DKAssetGroupDetailVideoCell.swift`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 166`** (5 nodes): `RunnerTests.swift`, `RunnerTests.swift`, `RunnerTests`, `.testExample()`, `XCTestCase`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 172`** (5 nodes): `AuthDispatcher`, `.dispatch()`, `.init()`, `AuthDispatcher.swift`, `AuthDispatcher.swift`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 176`** (5 nodes): `DKAsset+Export.swift`, `DKAsset`, `.getAssociatedObject()`, `.setAssociatedObject()`, `ExportKeys`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 181`** (4 nodes): `FIRComponentType.m`, `FIRComponentType.m`, `FIRComponentType`, `-instanceForProtocolinContainer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 182`** (4 nodes): `FBLPromise`, `-dispatchGroup`, `FBLPromise+Testing.m`, `FBLPromise+Testing.m`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 183`** (4 nodes): `FBLPromiseErrorIsTimedOut()`, `FBLPromiseErrorIsValidationFailure()`, `FBLPromiseError.h`, `FBLPromiseError.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 184`** (4 nodes): `GACAppCheckCryptoUtils.m`, `GACAppCheckCryptoUtils.m`, `GACAppCheckCryptoUtils`, `-sha256HashFromData`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 185`** (4 nodes): `NSURLSession`, `-gac_dataTaskPromiseWithRequest`, `NSURLSession+GACPromises.m`, `NSURLSession+GACPromises.m`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 186`** (4 nodes): `GACURLSessionDataResponse`, `-initWithResponseHTTPBody`, `GACURLSessionDataResponse.m`, `GACURLSessionDataResponse.m`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 187`** (4 nodes): `Base64URLEncodedStringExtension.swift`, `Base64URLEncodedStringExtension.swift`, `Data`, `.base64URLEncodedString()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 188`** (4 nodes): `AuthRPCRequest`, `.injectRecaptchaFields()`, `AuthRPCRequest.swift`, `AuthRPCRequest.swift`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 189`** (4 nodes): `AuthProto.swift`, `AuthProto.swift`, `AuthProto`, `.init()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 190`** (4 nodes): `GIDSignInResult.m`, `GIDSignInResult.m`, `GIDSignInResult`, `-initWithGoogleUserserverAuthCode`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 191`** (4 nodes): `GIDScopes.m`, `GIDScopes.m`, `GIDScopes`, `-scopesWithBasicProfile`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 192`** (4 nodes): `GIDActivityIndicatorViewController.m`, `GIDActivityIndicatorViewController.m`, `GIDActivityIndicatorViewController`, `-viewDidLoad`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 194`** (4 nodes): `handle_new_rx_page()`, `__lldb_init_module()`, `Intercept NOTIFY_DEBUGGER_ABOUT_RX_PAGES and touch the pages.`, `flutter_lldb_helper.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 195`** (4 nodes): `DKPhotoBasePreviewVC`, `.photoPreviewClass()`, `.photoPreviewVC()`, `DKPhotoPreviewFactory.swift`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 199`** (3 nodes): `DCAppAttestService`, `DCAppAttestService+GACAppAttestService.m`, `DCAppAttestService+GACAppAttestService.m`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 200`** (3 nodes): `AuthMFAResponse.swift`, `AuthMFAResponse.swift`, `AuthMFAResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 201`** (3 nodes): `NS_ENUM()`, `GULLoggerLevel.h`, `GULLoggerLevel.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 202`** (3 nodes): `AuthSessionStore.swift`, `AuthSessionStore.swift`, `AuthSessionStore`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 203`** (3 nodes): `AuthSessionDelegate.swift`, `AuthSessionDelegate.swift`, `AuthSessionDelegate`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 204`** (3 nodes): `GeneratedPluginRegistrant.m`, `GeneratedPluginRegistrant`, `-registerWithRegistry`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 205`** (3 nodes): `FlutterSceneDelegate`, `SceneDelegate.swift`, `SceneDelegate`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 207`** (3 nodes): `UIImage`, `-sd_imageWithGIFData`, `UIImage+GIF.m`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 208`** (3 nodes): `NSBezierPath+SDRoundedCorners.m`, `NSBezierPath`, `-sd_bezierPathWithRoundedRectbyRoundingCornerscornerRadius`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 209`** (2 nodes): `DKAssetGroupCellItemProtocol`, `DKAssetGroupCellItemProtocol.swift`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 210`** (2 nodes): `NSOperation`, `SDWebImageOperation.m`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 212`** (2 nodes): `MainActivity.kt`, `MainActivity`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 213`** (2 nodes): `date_formatter.dart`, `formatDate`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 214`** (2 nodes): `external_link.dart`, `ExternalLink`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 215`** (2 nodes): `attachment.dart`, `Attachment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `GTMOAuth2Compatibility` connect `Community 5` to `Community 1`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `GTMSessionFetcherSessionDelegateDispatcher` connect `Community 11` to `Community 1`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `DKAsset` connect `Community 16` to `Community 1`, `Community 4`?**
