...
2. `AuthErrorCode` - 95 edges
3. `GTMSessionUploadFetcher` - 94 edges
4. `error()` - 78 edges
5. `GTMSessionFetcherService` - 62 edges
6. `GIDSignIn` - 45 edges
7. `FIROptions` - 44 edges
8. `FIRApp` - 41 edges
9. `FBLPromise` - 37 edges
10. `GTMSessionFetcherSessionDelegateDispatcher` - 34 edges
...
Cohesion: 0.09
Nodes (10): AnyObject, AuthWebViewControllerDelegate, SFSafariViewControllerDelegate, UIView, UIViewController, AuthURLPresenter, AuthWebView, AuthWebViewController (+2 more)
...
Cohesion: 0.13
Nodes (8): GTMSessionFetcherAuthorizer, AuthorizationArguments, AuthSession, CallbackStyle, delegate, ErrorCode, accessTokenEmptyForRequest, cannotAuthorizeRequest
